...
namespace memoryGame
{
    public partial class ChoosePartner : Form
    {
        ...
        {
            partners = users.Where(p => p.UserName != GlobalProp.CurrentUser.UserName).ToList();
        ...
        private void dataGridView_partnerList_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create($@"http://localhost:52339/ChoosePatner/{partner.UserName}");
        ...
        public List<User> GetUsersList()
        {
            ...
            client.BaseAddress = new Uri(@"http://localhost:52339/");
